...
bot.on('message', message =>{hello}
    ...
    if(message.author.id != "765515771333443584" && message.channel.id === "765863963053260820"){
        if(msg.startsWith('>', 0)){
            if(msg === prefix + "bang" && message.channel.id === "765863963053260820"){
